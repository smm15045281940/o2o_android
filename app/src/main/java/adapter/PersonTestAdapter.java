...
public class PersonTestAdapter extends CommonAdapter<PersonBean> {

    public PersonTestAdapter(Context context, List<PersonBean> list) {
        super(context, list);
    }
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View itemView) {
            imageIv = (ImageView) itemView.findViewById(R.id.iv_item_person_img);
            ...
            playTv = (TextView) itemView.findViewById(R.id.tv_item_person_info);
