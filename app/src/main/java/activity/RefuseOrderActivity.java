...
public class RefuseOrderActivity extends CommonActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected View getRootView() {
        return rootView = LayoutInflater.from(this).inflate(R.layout.activity_refuse_order, null);
    }
